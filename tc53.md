...
Because displays have many options, the `configure` method may implement support for many properties. A given call to `configure` method should only modify the configuration properties included in the options object. 

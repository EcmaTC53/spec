...
| Property | Description |
| :---: | :--- |
|  `out` | The Serial Data Out pin. This property is required when using the SPI bus to write data.
|  `in` | The Serial Data In pin. This property is required when using the SPI bus to read data.

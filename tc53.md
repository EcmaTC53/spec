<p id="subtitle">TC53 DRAFT / June 23, 2020</p>
...
>**Note**: These are more industry consensus than industry standard. May be challenging to find a definitive reference. How to handle? Where to look for guidance?
...
If the sample data includes one or more timestamps that indicate when the sample was collected, those timestamps in the returned sample object should conform to the Sensor Data Provence Rules.
...
The `Accelerometer` class implements access to a generic three-dimensional accelerometer.

#### Normative Reference

This specification is compatible with the [W3C Accelerometer draft](https://w3c.github.io/accelerometer/).
...
The `AmbientLight` class implements access to a generic ambient light sensor. 

#### Normative Reference

This specification is compatible with the [W3C Ambient Light Sensor draft](https://www.w3.org/TR/ambient-light/).
...
The `Proximity` class implements access to a generic proximity sensor or range finder.

#### Normative Reference

This specification is compatible with the [W3C Proximity Sensor draft](https://w3c.github.io/proximity/).
